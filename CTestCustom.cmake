# Generated by cmake from /home/apollyon/Dev/openscad/tests/CTestCustom.template
#
...
set(ENV{OPENSCADPATH} "/home/apollyon/Dev/openscad/libraries")
...
if(Linux MATCHES "Linux|BSD")
  ...
  if (ON)
    message("running '/home/apollyon/Dev/openscad/openscad --info' to detect EGL")
    execute_process(COMMAND /home/apollyon/Dev/openscad/openscad --info RESULT_VARIABLE INFO_RESULT)
    if(INFO_RESULT)
      set(USE_X11 TRUE)
    endif()
  else()
  ...
  if(USE_X11)
   ...
   if(DISPLAY_ENV)
    ...
    execute_process(
     COMMAND /home/apollyon/Dev/openscad/tests/virtualfb.sh OUTPUT_VARIABLE SVFB_OUT)
    ...
    set(CTEST_CUSTOM_POST_TEST "/home/apollyon/Dev/openscad/tests/virtualfb.sh")
   endif()
  endif()
endif()
...
message("running '/home/apollyon/Dev/openscad/openscad --info' to generate sysinfo.txt")
execute_process(COMMAND /home/apollyon/Dev/openscad/openscad --info OUTPUT_FILE sysinfo.txt)

set(CTEST_CUSTOM_POST_TEST ${CTEST_CUSTOM_POST_TEST} "/usr/bin/python3.14 \"/home/apollyon/Dev/openscad/tests/test_pretty_print.py\" --builddir=/home/apollyon/Dev/openscad")
